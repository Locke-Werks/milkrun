# MilkDrop 3 feature reference

This is the upstream MilkDrop 3 documentation by milkdrop2077, kept because it still
describes this fork's visualizer behaviour and keyboard shortcuts accurately. Social
and funding links have been removed; everything else is as written.

Milk Run adds offline rendering on top of what is described here. See the top-level
README for that.
...
Create new colors by pressing just the key 'c'.<br/>
...
- Support auto-changing the presets based on beat detection (F8) <br/>
